...
describe('Preferences Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PreferencesUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const manytoone: IUser = { id: 2567 };
      preferences.manytoone = manytoone;

      const userCollection: IUser[] = [{ id: 24765 }];
