...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../weight.test-samples';

import { RestWeight, WeightService } from './weight.service';
