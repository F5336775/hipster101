...
import { sampleWithRequiredData } from '../preference.test-samples';
...
describe('Preference Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to preferenceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPreferenceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPreferenceIdentifier).toHaveBeenCalledWith(entity);
